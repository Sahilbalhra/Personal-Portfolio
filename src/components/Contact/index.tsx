...
export default function Contact() {
	...
	return (
		<motion.section
			id="contact"
			ref={ref}
			className="mb-40 w-[min(100%,38rem)] text-center sm:mb-28"
			initial={{
				opacity: 0,
			}}
			whileInView={{
		...
		>
			...
			<p className="-mt-6 text-gray-700 dark:text-white/80">
				...
				<a className="underline" href="mailto:sahilbalhra0@gmail.com">
					sahilbalhra0@gmail.com
				</a>{' '}
			...
			<form
				...
				action={async (formData) => {
					...
					toast('Your message has been successfully sent!', {
						icon: <CircleCheck className="text-green-700" />,
						duration: 1000,
					});
				}}
			>
